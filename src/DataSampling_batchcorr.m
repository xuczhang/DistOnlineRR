function [] = DataSampling_batchcorr( p, k, batch_cr, bNoise, block_num, idx)
    ...
    corr_batch = batch_cr * block_num;
    cb_idx = randperm(block_num, corr_batch);
    cr_v = ones(block_num, 1)*(1/block_num * 0.1);
    cr_v(cb_idx) = (1/block_num * 0.9);
    ...
    data_file = FindDataPath_batchcorr( p, k, batch_cr, bNoise, block_num, idx );
